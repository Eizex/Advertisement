...
+function ($) {
    ...
    Validator.prototype.toggleSubmit = function () {
        ...
        if(this.isIncomplete() || this.hasErrors()){
            this.$btn.addClass('disabled').prop('disabled',true).parent().tooltip({title: 'بعض المدخلات فارغة أو غير صحيحة',trigger: 'hover'});
        } else{
            this.$btn.removeClass('disabled').prop('disabled',false).parent().tooltip('destroy');
        }
    }
